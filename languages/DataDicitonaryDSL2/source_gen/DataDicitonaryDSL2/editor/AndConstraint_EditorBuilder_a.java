...
/*package*/ class AndConstraint_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new constraint1SingleRoleHandler_ybzli4_b0(myNode, LINKS.constraint1$wJEh, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new constraint2SingleRoleHandler_ybzli4_d0(myNode, LINKS.constraint2$wK8j, getEditorContext());
    return provider.createCell();
  }
