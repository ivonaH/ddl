...
public class SemanticDomain_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_qrk353_a(), CONCEPTS.SemanticDomain$Me));
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for SemanticDomain. Generated from implicit smart reference attribute.", new SNodePointer("r:b98f07a2-a3fa-4b01-9c54-bc49c2e05642(DataDicitonaryDSL2.structure)", "7032480833813296505")));
    try {
  ...
  public class SMP_ReferenceScope_qrk353_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_qrk353_a() {
      ...
      super((SAbstractConcept) CONCEPTS.SemanticDomain$Me, LINKS.domainRef$oCPK);
    }
    @NotNull
    @Override
  ...
  public class SMP_Subconcepts_qrk353_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.SemanticDomain$Me);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
